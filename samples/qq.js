...
(function(g) {
    function a(o, v) {
        var D, p, y, F, H, M, P, E, G, O = v && v.split("/"),
            u = z.map,
            s = u && u["*"] || {};
        if (o && o.charAt(0) === ".")
            if (v) {
    ...
    k = function(o, v) {
        ...
        if (y) o = D && D.normalize ? D.normalize(o, c(v)) : a(o, v);
        else {
            o = a(o, v);
            p = f(o);
            y = p[0];
    ...
    m = function(o, v, D, p) {
        ...
        if (F === "undefined" || F === "function") {
            ...
            for (M = 0; M < v.length; M += 1) {
                H = k(v[M], p);
                F = H.f;
                if (F === "require") P[M] = d.require(o);
                else if (F === "exports") {
                    P[M] = d.exports(o);
                    E = true
                } else if (F ===
                    "module") y = P[M] = d.module(o);
                else if (w.call(t, F) || w.call(B, F) || w.call(q, F)) P[M] = j(F);
                else if (H.p) {
            ...
            if (o)
                if (y && y.exports !== g && y.exports !== t[o]) t[o] = y.exports;
                else if (v !== g || !E) t[o] = v
        } else if (o) t[o] = D
    };
    ...
    var g = {
        ...
        $package: function(a, b) {
            ...
            if (typeof a == "function") {
                b = a;
                c = window
            } else if (typeof a == "string") c = this.$namespace(a);
        ...
        indexOf: function(a, b) {
            var c = g.type;
            if (a.length) return [].indexOf.call(a, b);
        ...
        every: function(a, b) {
            if (a.length) return [].every.call(a, b);
        ...
        some: function(a, b) {
            if (a.length) return [].some.call(a, b);
            else if ($T.isObject(a)) {
                var c = false;
                this.each(a, function(e, j, f) {
                    if (b(e, j, f)) c = true
        ...
        each: function(a, b) {
            var c = g.type;
            if (a.length) return [].forEach.call(a, b);
            else if (c.isObject(a))
                for (var e in a)
                    if (a.hasOwnProperty(e))
                        if (b.call(a[e], a[e], e, a) === false) break
        },
        map: function(a,
            b) {
            var c = g.type;
            if (a.length)[].map.call(a, b);
            else if (c.isObject(a))
                for (var e in a)
                    if (a.hasOwnProperty(e)) a[e] = b.call(a[e], a[e], e, a)
        },
        filter: function(a, b) {
            var c = g.type;
            if (a.length) return [].filter.call(a, b);
            else if (c.isObject(a)) {
                var e = {};
    ...
    var a = document,
        ...
        r = {
            $: function(k, d) {
                var t;
                d = d || a;
                if (e.test(k)) return (t = this.id(k.replace("#", ""))) ? [t] : [];
                else t = c.test(k) ? this.tagName(k, d) : j.test(k) ? this.className(k.replace(".", ""), d) : d.querySelectorAll(k);
                return g.toArray(t)
            },
            id: function(k) {
            ...
            className: function(k, d) {
                var t, B, z, q, w;
                d = d || a;
                if (d.getElementsByClassName) return d.getElementsByClassName(k);
                else {
                    t = d.getElementsByTagName("*");
                    B = [];
                    z = 0;
                    for (q = t.length; z < q; ++z)
                        if (w = t[z].className && g.indexOf(w.split(" "), k) >= 0) B.push(t[z]);
                    return B
                }
            },
            remove: function(k) {
            ...
            getStyle: function(k, d) {
                if (k) {
                    ...
                    if (k.style[d]) return k.style[d];
                    else if (window.getComputedStyle) return window.getComputedStyle(k, null)[d];
...
J.$package(function(g) {
    ...
    g.format.date = function(a, b) {
        ...
        for (var e in c)
            if (RegExp("(" + e + ")").test(b)) b = b.replace(RegExp.$1, RegExp.$1.length == 1 ? c[e] : ("00" + c[e]).substr(("" + c[e]).length));
        return b
    }
});
J.$package(function(g) {
    var a = window,
        ...
        j = {
            ...
            transitionend: function() {
                var f, n, m, r;
                if ("ontransitionend" in a) return "transitionend";
                else if ("onwebkittransitionend" in
                    a) return "webkitTransitionEnd";
                else if ("transition" in b.body.style) return "transitionend";
            ...
            flash: function() {
                if (c.plugins && c.plugins.length && c.plugins["Shockwave Flash"]) return true;
...
J.$package(function(g) {
    var a = g.type,
        ...
        c = window,
        e = function(q, w) {
            if (("on" + w).toLowerCase() in q) return w;
            else if (b.transitionend && (w === "transitionend" || w === b.transitionend)) return b.transitionend;
            return false
        },
        j = function(q, w, C) {
            var h;
            if (q.addEventListener) q.addEventListener(w, C, false);
            else {
                w = w.toLowerCase();
                if (q.attachEvent) q.attachEvent("on" + w, C);
                else {
                    h = q["on" + w];
                    q["on" + w] = function() {
        ...
        f = function(q, w, C) {
            if (q.removeEventListener) q.removeEventListener(w,
                ...
                w = w.toLowerCase();
                if (q.detachEvent) q.detachEvent("on" + w, C);
                else q["on" + w] = null
            }
        },
        n = {
            on: function(q, w, C) {
                var h;
                if (a.isArray(q))
                    for (h = q.length; h--;) n.on(q[h], w, C);
                else if (a.isString(w) && w.indexOf(" ") > 0) {
                    w = w.split(" ");
                    for (h = w.length; h--;) n.on(q, w[h], C)
                } else if (a.isArray(C))
                    for (h = C.length; h--;) n.on(q, w, C[h]);
                else if (a.isObject(w))
                    for (h in w) n.on(q, h, w[h]);
                else if (h = e(q, w)) {
                    w = h;
                    j(q, w, C)
            ...
            off: function(q, w, C) {
                if (a.isString(w) && w.indexOf(" ") > 0) {
                    ...
                    for (h = C.length; h--;) n.off(q, w, C[h]);
                else if (a.isObject(w))
                    for (h in w) n.off(q, h, w[h]);
            ...
            bindCommands: function(q, w, C, h) {
                ...
                if (q._commends[w]) g.extend(q._commends[w], C);
                else {
                    q._commends[w] = C;
                    h = h || "cmd";
...
J.$package(function(g) {
    var a = g.dom,
        ...
        j = g.Class({
            ...
            setElems: function(f) {
                if (c.isString(f)) this.elems = a.$(f);
                else if (c.isArray(f)) this.elems = f;
                else if (f.tagName) this.elems = [f];
                return this
            },
...
(function(g, a) {
    ...
    var c = Math,
        ...
        f = j ? "-" + j.toLowerCase() + "-" : "",
        n = b("transform"),
        m = b("transitionProperty"),
        r = b("transitionDuration"),
        k = b("transformOrigin"),
        d = b("transitionTimingFunction"),
        t = b("transitionDelay"),
        ...
        C = "ontouchstart" in g && !q,
        h = !!j,
        o = b("transition") in e,
        v = "onorientationchange" in g ? "orientationchange" : "resize",
        D = C ? "touchstart" : "mousedown",
        p = C ? "touchmove" : "mousemove",
        y = C ? "touchend" : "mouseup",
        F = C ? "touchcancel" : "mouseup",
        H = j == "Moz" ? "DOMMouseScroll" : "mousewheel",
        M;
    M = j === false ? false : {
        "": "transitionend",
    ...
    var P = function() {
        ...
        O = function(u, s) {
            ...
            if (A.options.useTransform) A.scroller.style[n] = "translate(" + A.x + "px," + A.y + "px)" + G;
            else A.scroller.style.cssText += ";position:absolute;top:" + A.y + "px;left:" + A.x + "px";
    ...
    O.prototype = {
        ...
        _scrollbar: function(u) {
            ...
            if (this[u + "Scrollbar"]) {
                if (!this[u + "ScrollbarWrapper"]) {
                    ...
                    if (this.options.scrollbarClass) s.className = this.options.scrollbarClass + u.toUpperCase();
        ...
        _pos: function(u, s) {
            if (!this.zoomed) {
                u = this.hScroll ? u : 0;
                s = this.vScroll ? s : 0;
                if (this.options.useTransform) this.scroller.style[n] = "translate(" + u + "px," + s + "px) scale(" + this.scale + ")" + G;
                else {
                    u = c.round(u);
                    s = c.round(s);
        ...
        _scrollbarPos: function(u,
            ...
            if (this[u + "Scrollbar"]) {
                ...
                if (A < 0) {
                    ...
                    if (this.options.fixedScrollbar) A = this[u + "ScrollbarMaxScroll"];
                    else {
        ...
        _move: function(u) {
            ...
            if (this.options.zoom && C && u.touches.length > 1) {
                ...
                if (s < this.options.zoomMin) s = 0.5 * this.options.zoomMin * Math.pow(2, s / this.options.zoomMin);
                else if (s > this.options.zoomMax) s = 2 * this.options.zoomMax * Math.pow(0.5, this.options.zoomMax / s);
        ...
        _end: function(u) {
            if (!(C && u.touches.length !== 0)) {
                var s = this,
                    ...
                    X = (u.timeStamp || Date.now()) - s.startTime,
                    x = s.x,
                    I = s.y;
                s._unbind(p);
                s._unbind(y);
                ...
                if (s.zoomed) {
                    ...
                    if (s.moved) {
                        if (X <
                            ...
                            x = s.x + Q.dist;
                            I = s.y + R.dist;
                            if (s.x > 0 && x > 0 || s.x < s.maxScrollX && x < s.maxScrollX) Q = {
                                dist: 0,
                                time: 0
                            };
                        ...
                        if (Q.dist || R.dist) {
                            ...
                            if (s.options.snap) {
                                R = x - s.absStartX;
                                X = I - s.absStartY;
                                if (c.abs(R) < s.options.snapThreshold && c.abs(X) < s.options.snapThreshold) s.scrollTo(s.absStartX, s.absStartY, 200);
                                else {
                                    R = s._snap(x, I);
                                    x = R.x;
                                    I = R.y;
                            ...
                            if (c.abs(R) < s.options.snapThreshold && c.abs(X) <
                                s.options.snapThreshold) s.scrollTo(s.absStartX, s.absStartY, 200);
                            else {
                                R = s._snap(s.x, s.y);
        ...
        _wheel: function(u) {
            ...
            if ("wheelDeltaX" in u) {
                A = u.wheelDeltaX / 2;
                K = u.wheelDeltaY / 2
            } else if ("wheelDelta" in u) A = K = u.wheelDelta / 2;
            else if ("detail" in u) A = K = -u.detail * 9;
            else return;
            if (s.options.wheelAction == "zoom") {
                ...
                K = s.y + K;
                if (A > 0) A = 0;
                else if (A < s.maxScrollX) A = s.maxScrollX;
                if (K > s.minScrollY) K = s.minScrollY;
                else if (K < s.maxScrollY) K = s.maxScrollY;
        ...
        _offset: function(u) {
            for (var s = -u.offsetLeft, A = -u.offsetTop; u = u.offsetParent;) {
                s -= u.offsetLeft;
                A -= u.offsetTop
            }
            if (u != this.wrapper) {
...
(function() {
    ...
    var a, b, c, e, j, f, n, m, r, k, d, t, B = 0,
        z = 0;
    _ver = "tcss.3.1.5";
    ...
    var C = {
        ...
        get: function(h, o) {
            var v = o ? a.cookie : this.get("pgv_info=", true),
                D = "-",
                p;
            p = v.indexOf(h);
            if (p > -1) {
    ...
    J.$package("mq", function() {
        ...
        this.saveSetting = function(a) {
            for (var b = ["enableVoice", "enableNotification", "enableHttps", "enableCtrlEnter"], c = 0, e; e = b[c]; c++)
                if (e in a) this.setting[e] = localStorage[e] = a[e]
        }
    })
});
define("tmpl", {
    ...
    JM.$package("MUI", function(g) {
        ...
        this.Tab = new g.Class({
            ...
            select: function(e, j, f) {
                ...
                if (this._selectedIndex === e.index) this._selectedIndex = -1;
                else {
            ...
            add: function(e,
                ...
                this._map[e.id] = e;
                if (typeof j == "undefined") this._arr.push(e);
                else {
    ...
    JM.$package("MUI", function(g) {
        ...
        this.AutoGrowTextarea = g.Class({
            ...
            adjust: function() {
                ...
                if (c > this.maxHeight) c = this.maxHeight;
                else if (c < this.initHeight) c = this.initHeight;
    ...
    JM.$package("MUI", function(g) {
        ...
        this.I_LazyLoadImgs = g.Class({
            ...
            _onScrollEnd: function() {
                var c = this,
                    e = this._loadFunc,
                    j = this.souceProperty,
                    f = a.$("img[" + j + "]", this.elem),
                    n;
                if (f.length != 0) {
                    g.each(f, function(m) {
                        if (c.inVisibleArea(m) && (n = m.getAttribute(j))) e(m, n);
                        else return false
                    });
...
define("../lib/mui/js/mui.swipechange", ["jm", "./mui.slide"], function() {
    JM.$package("MUI", function(g) {
        var a = g.dom,
            b = g.event,
            c = g.platform.touchDevice,
            e, j = (c = g.platform.touchDevice) ? "touchstart" : "mousedown",
            f = c ? "touchmove" : "mousemove",
            n = c ? "touchend" : "mouseup",
            m = "getBoundingClientRect" in document.body,
            r = g.Class({
                extend: MUI.Slide
            }, {
                init: function(k) {
                ...
                _onEndEvt: function() {
                    if (e) {
                        ...
                        if (k > d) t = Math.max(0, t - 1);
                        else if (k < -d) t = Math.min(this.contents.length - 1, t + 1);
                        this.slideTo(t);
                        e = null;
                        this.moveDist = 0
                    }
    ...
    J.$package("mq.view", function(b) {
        ...
        this.TitlePanel = b.Class({
            init: function(m) {
                ...
                if (m.leftButton) r.leftButton = b.extend({
                    text: f("return"),
                    className: ""
                }, m.leftButton);
                if (m.hasBackButton) r.leftButton = {
                    className: "btn_arrow_left",
                    text: f("return")
                };
                if (m.rightButton) r.rightButton = b.extend({
                    text: "",
                    className: ""
                }, m.rightButton);
                this.create(g)
            ...
            n = function(m, r) {
                if (m) {
                    ...
                    if (k)
                        if (r)
                            if (a.isArray(r))
                                for (var d in k) d in r && delete k[d]
                }
            };
        (function() {
...
define("mq.rpcservice", ["./mq.portal", "./mq.report"], function() {
    ...
    J.$package("mq.rpcService", function(g) {
        var a = this,
            b = JM.event,
            c = JM.dom,
            e = mq.DYNAMIC_CGI_URL + "channel/login2",
            j = mq.DYNAMIC_CGI_URL + "channel/poll2",
            f = mq.STATIC_CGI_URL + "api/getvfwebqq",
            n = mq.DYNAMIC_CGI_URL + "channel/refuse_file2",
            m = mq.DYNAMIC_CGI_URL + "channel/notify_offfile2",
            r = {
            ...
            B = new g.Class({
                init: function(E, G) {
                    var O = "qqweb_proxySendIframe_" + E,
                        u = this,
                        s;
                    this.iframeName = O;
                    this._ajaxCallbacks = [];
            ...
            z = new g.Class({
                ...
                cfProxySend: function(E, G) {
                    ...
                    var u = RegExp.$1;
                    if ("postMessage" in window && !g.browser.ie) window.frames[G.iframeName].postMessage(O, u);
                    else {
                        var s = c.node("div");
            ...
            q = new g.Class({
                ...
                getProxyById: function(E) {
                    for (var G in this._proxyArr)
                        if (this._proxyArr[G].id == E) return this._proxyArr[G];
                    return null
                }
            });
        ...
        var D = function(E) {
                ...
                } else if (G === 100) b.fire(a, "NotReLogin");
                else if (G === 120) b.fire(a, "ReLinkFailure", E);
                else if (G === 121) b.fire(a,
                    "ReLinkFailure", E);
                else if (G === 116) {
                    mq.main.setValidate({
                        ptwebqq: E.p
    ...
    J.$package("mq.view", function(g) {
        ...
        this.MemberList = g.Class({
            ...
            renderOneState: function(j, f) {
                var n = this.listContainer.querySelector("#friend-item-friend-" + j);
                if (n)
                    if (n = n.querySelector(".member_state")) n.innerHTML = "[" + c(f) + "]"
            },
            renderAllOnlineStateCount: function(j) {
                var f = a.className("onlinePercent"),
                    n;
...
define("mq.model.memberlist", ["./mq.i18n", "./mq.portal", "./mq.report"], function() {
    J.$package("mq.model.buddylist", function(g) {
        var a = JM.event,
            ...
            q = [],
            w = {},
            C, h, o = mq.STATIC_CGI_URL + "api/get_user_friends2",
            v = mq.STATIC_CGI_URL + "api/get_group_name_list_mask2",
            D = mq.STATIC_CGI_URL + "api/get_discus_list",
            p = mq.DYNAMIC_CGI_URL + "channel/get_recent_list2",
            y = mq.STATIC_CGI_URL + "api/get_single_long_nick2",
            F = mq.STATIC_CGI_URL + "api/get_self_info2",
            H = mq.STATIC_CGI_URL + "api/get_group_info_ext2",
            M = mq.DYNAMIC_CGI_URL + "channel/get_discu_info",
            P = mq.STATIC_CGI_URL + "api/get_friend_info2",
            E = mq.STATIC_CGI_URL + "api/get_friend_uin2",
            G = mq.DYNAMIC_CGI_URL + "channel/get_online_buddies2",
            O = mq.DYNAMIC_CGI_URL + "channel/change_status2",
            u = function(x, I) {
                x += "";
            ...
            c = {
                onRecentListChange: function(e) {
                    for (var j = b.model, f = j.getSelfUin(), n = [], m, r = 0, k; k = e[r]; r++)
                        if (k.uin != f) {
                            if (k.type == 0) m = j.getFriendByUin(k.uin);
                            else if (k.type == 1) m = j.getGroupByGid(k.uin);
                            else if (k.type == 2) m = j.getDiscussById(k.uin);
                            m && n.push(m)
                        }
...
define("mq.model.chat", ["./mq.portal"], function() {
    J.$package("mq.model.chat", function(g) {
        var a = JM.event,
            b = mq.DYNAMIC_CGI_URL + "channel/send_buddy_msg2",
            c = mq.DYNAMIC_CGI_URL + "channel/send_sess_msg2",
            e = mq.DYNAMIC_CGI_URL + "channel/send_qun_msg2",
            j = mq.DYNAMIC_CGI_URL + "channel/send_discu_msg2",
            f = mq.DYNAMIC_CGI_URL + "channel/get_c2cmsg_sig2",
            n = this,
            m = {},
            r = {},
            k = {},
        ...
        this.getMessages = function(h, o) {
            o = o || "friend";
            var v = [];
            if (o == "friend") v = this.getMsgByUin(h);
            else if (o == "group") v = this.getGroupMsgByGid(h);
            else if (o == "discuss") v = this.getDiscussMsgByDid(h);
            return v
        };
        ...
        this.receiveTransferMsg = function(h) {
            ...
            if (o.file_name != "") {
                ...
                if (o.isFinished || typeof t[h.session_id] != "undefined" && t[h.session_id] === true) return false;
                else o.isFinished = true;
                this.receiveMessage({
                    type: "file_message",
                    system: true,
                    to_uin: h.to_uin,
        ...
        this.receiveFile = function(h) {
            if (h.mode === "recv") {
                ...
                if (h.type !== 161) {
                    ...
                    if (v.isFinished) return false;
                    else d[o].isFinished = true;
                    o = [
                        ["rffile", v.name]
                    ];
                    v.type = "rffile";
    ...
    J.$package("mq.presenter.chat", function(g) {
        ...
        this.translateMessage = function(p) {
            for (var y =
                ...
                if (g.type.isArray(E)) switch (E[0]) {
                    case "font":
                        break;
                    case "face":
                        E = z.indexOf(E[1]);
        ...
        this.translateMessage2Text = function(p) {
            ...
            var y = [],
                F, H;
            for (F = 0; H = p[F]; ++F)
                if (g.type.isArray(H)) switch (H[0]) {
                    case "face":
        ...
        var f = {
            ...
            n = {
                onSearchInput: function() {
                    if (b.searchInput.value != "") e.hasClass(b.searchBar, "hascontent") || e.addClass(b.searchBar, "hascontent");
                    else e.removeClass(b.searchBar, "hascontent");
    ...
    J.$package("mq.view.profile", function() {
        ...
        var m = {
            ...
            sendMsg2Member: function() {
                ...
                if (r.group) k.group_uin = r.group.gid;
                else if (r.discuss) k.discuss_uin = r.discuss.did;
...
define("mq.view.record", ["tmpl!../tmpl/tmpl_record_footer.html", "./mq.i18n", "./mq.view.transitionmanager"], function(g) {
    J.$package("mq.view.record", function(a) {
        ...
        this.renderRecord = function(k) {
            ...
            w.innerHTML = "";
            if (!q || q.length == 0) w.innerHTML += "<p class='no_record'>" + f("noRecord") + "</p>";
            else {
                d = 0;
    ...
    J.$package("mq.view.contact", function(b) {
        ...
        this.init = function() {
            ...
            for (var k = [], d = j.id("memberTab").children, t, B = 0, z, q, w; z = d[B]; B++) {
                ...
                if (q === "friend") {
                    for (t in r)
                        if (r.hasOwnProperty(t)) this.memberListAreas[q][t] = r[t];
        ...
        var n = {
            ...
            r = {
                onScrollEnd: function() {
                    var k = this.listContainer.querySelectorAll(".active"),
                        d, t, B, z, q, w, C;
                    if (k && k.length) {
        ...
        var c = function() {
            ...
            j = function() {
                if (window.Audio && (new Audio).canPlayType("audio/mpeg")) {
                    ...
                    var d;
                    if (g.browser.plugins.flash >= 9) d = b.FLASH;
                    else {
            ...
            case b.MOBILE:
                ...
                g.Audio = g.Class({
                    ...
                    play: function(d) {
                        var t = n.length;
                        if (t && n[t - 1] !== this) {
                            t = g.indexOf(n, this); - 1 !== t ? n.splice(t, 1) : this.on("ended", m)
                        }
                        n.push(this);
                        if (d) this._el.src = d;
                        this._el.paused && this._el.play()
                    ...
                    _startPoll: function() {
                        if (this._timer === undefined) {
                            ...
                            this._timer = setInterval(function() {
                                if (d._isPlaying &&
                                    !d._isBuffering && (d._handler.timeupdate || 0).length && (d._el.currentMedia || 0).sourceURL) d._fire("timeupdate");
                                var t = d.getDuration();
                                if (d._duration !== t) {
                                    d._duration = t;
...
define("mq.view.desktopNotificationManager", ["jm"], function() {
    J.$package("mq.view.desktopNotificationManager", function(g) {
        ...
        function b() {
            ...
            if (t)
                if ((q = f.Notification) &&
                    q.permission) return q.permission;
                else if ((q = f.webkitNotifications) && q.checkPermission) return k[f.webkitNotifications.checkPermission()];
            else if (n.mozNotification) return r;
            else if ((q = f.Notification) && q.permission) permission = q.permissionLevel()
        }
        ...
        function c(q) {
            if (q) return {
                ...
                close: function() {
                    var w;
                    if (j.isFunction(q.close)) w = q.close();
                    else if (j.isFunction(q.cancel)) w = q.cancel();
        ...
        this.requestPermission = function(q) {
            if (t) {
                ...
                if (f.webkitNotifications && f.webkitNotifications.requestPermission) return f.webkitNotifications.requestPermission();
                else if (f.Notification && f.Notification.requestPermission) return f.Notification.requestPermission(q)
            }
        }
    })
});
...
define("mq.view.main", ["tmpl!../tmpl/tmpl_main_footer.html", "./mq.i18n", "./mq.view.transitionmanager"], function(g) {
    J.$package("mq.view.main", function(a) {
        var b = this,
            c, e, j, f = window.localStorage.localBgImage,
            n = JM.event,
            m = JM.dom,
            r = mq.i18n.message;
        this.init = function() {
            ...
            if (a.platform.touchDevice) z = m.id("container");
            else {
        ...
        var k = function() {
                setTimeout(function() {
                    if (e == c) window.localStorage && window.localStorage.setItem("localBgImage", e);
                    else {
                        e = c;
                        k()
                    }
...
define("qtracker", [], function() {
    (function(g, a) {
        ...
        var c = {
            ...
            f = function(k, d) {
                var t = function() {
                    if (this instanceof arguments.callee) this.__init__ && this.__init__.apply(this, arguments);
                    else throw Error("You must new an instance");
                };
                if (d) {
                    t.prototype = new d;
                    for (var B in k)
            ...
            m = f({
                ...
                _isFree: function(k, d) {
                    if (k && "ts" in k && +new Date - k.ts < this.timeout * 1E3) return false;
                    else if (k && "ts" in k) {
                        if (!k.finish) {
                            this._onError();
                            this._setFree(d);
        ...
        n = f({
            ...
            add: function(k) {
                ...
                if (k) k.add.apply(k, Array.prototype.slice.call(arguments, 1));
                else throw Error("No such Page!Check the page name.");
            },
            send: function(k) {
                if (k = this.pages[k]) k.send();
                else throw Error("No such Page!Check the page name.");
            }
        });
        var r = f({
...
require(["jm", "iscroll", "./mq.portal", "./mq.main", "./mq.report"], function() {
    var g = window.navigator.userAgent.toLowerCase(),
        a, b, c;
    if (J.platform.touchDevice || g.indexOf("webkit") >= 1 || g.indexOf("gecko") >= 1) mq.main.start();
